...
class TopicListView(ListView):
    ...
    def get_queryset(self):
        self.board = get_object_or_404(Boards, pk=self.kwargs.get('board_primary_key'))
...
class PostListView(ListView):
    ...
    def get_queryset(self):
        self.topic = get_object_or_404(Topic, board__pk=self.kwargs.get('board_primary_key'), pk=self.kwargs.get('topic_pk'))
...
class PostUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        post.save()
        return redirect('topic_posts', board_primary_key=post.topic.board.pk, topic_pk=post.topic.pk)
